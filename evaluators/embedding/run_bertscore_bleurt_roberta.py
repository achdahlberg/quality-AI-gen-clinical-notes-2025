"""
BERTScore (roberta-large) + BLEURT, verbose logs.
"""
...
# reduce tokenizer thread weirdness on macOS
...
BERTSCORE_DEVICE = "cpu"  # CPU for mac
...
def compute_bertscore(ref: str, hyp: str, lang_code: str):
    # rescale baseline recommended for en with roberta-large only
    use_baseline = lang_code == "en" and BERTSCORE_MODEL_TYPE == "roberta-large"
